...
<head>
   ...
   <style>
    body {
      ...
      padding-top: 80px; /* مسافة لأسفل الـ Navbar الثابت */
      margin: 0;
      min-height: 100vh;
      display: flex;
    ...
    main {
      flex-grow: 1; /* يجعل المحتوى يأخذ المساحة المتاحة ويدفع الفوتر للأسفل */
      display: flex;
      justify-content: center;
      align-items: center;
      padding: 20px 0; /* مسافة داخلية للمحتوى */
    }
    ...
    .container-box {
      ...
      background: rgba(255, 255, 255, 0.15); /* خلفية شبه شفافة للكارد */
    }
   .left {
      flex: 1;
      position: relative;
    ...
    <div class="container-box">
        <div class="left d-flex flex-column justify-content-center align-items-center p-5">
            <div class="left-content text-center">
                <h2>Welcome Back 👋</h2>
                <p>Log in to access amazing courses & community.</p>
            </div>
        </div>
        <div class="right">
            <h3 class="text-white text-center mb-4">Login to Your Account</h3>
